        ...
        <>
            ...
            <div className="p-6 flex-1 space-y-8">
                ...
                <div className="space-y-6">
                    ...
                    <div>
                        <label htmlFor="status-select" className="block text-xs text-gray-500 uppercase tracking-wider font-semibold mb-2">Update Status</label>
                        <select
                            id="status-select"
                    ...
                    <div>
                        <div className="flex items-center justify-between mb-2">
                            <label htmlFor="private-notes" className="block text-xs text-gray-500 uppercase tracking-wider font-semibold">Private Notes</label>
