                            ...
                            >
                                ...
                                <form onSubmit={onLoginSubmit} className="space-y-4">
                                    <div className="relative">
                                        <input
                                            className="w-full rounded-xl border border-white/10 px-4 py-4 pr-12 bg-black/50 text-white outline-none focus:border-orange-500/50 transition placeholder:text-gray-600"
